...
namespace Core.Input
{
	...
	public class InputController : Singleton<InputController>
	{
        ...
        void Start()
        {
            UnityEngine.Debug.Log("Mouse Drag Threshold: " + dragThresholdMouse);
        }
			...
			for (int i = 0; i < trackMouseButtons; ++i)
			{
				...
				if (UnityInput.GetMouseButton(i))
				{
					...
					else
					{
                        ...
                        UnityEngine.Debug.Log("Total Movement: " + mouseButton.totalMovement);
                        if (mouseButton.totalMovement > dragThresholdMouse)
						{
							...
							if (dragged != null)
							{
                                UnityEngine.Debug.Log("Drag Event Invoked");
                                dragged(mouseButton);
							}
